...
wps = Dict()
wps["Rodas5"] =
    MyWorkPrecision(prob, Rodas5(), abstols ./ 100, reltols ./ 100; appxsol=appxsol)
wps["Rosenbrock23"] = MyWorkPrecision(
    prob,
    Rosenbrock23(),
    abstols[1:end-1],
    reltols[1:end-1];
...
wps["RadauIIA5"] =
    MyWorkPrecision(prob, RadauIIA5(), abstols ./ 100, reltols ./ 100; appxsol=appxsol)
