...
npn_keys, npn_labels =
    zip([("Rosenbrock23", "Rosen-\nbrock23"), ("Rodas5", "Rodas5"), ("QNDF", "QNDF")]...)

pn_keys, pn_labels =
    zip([("EK1(2)", "EK1(2)"), ("EK1(3)", "EK1(3)"), ("EK1(5)", "EK1(5)")]...)

fig = Figure(resolution=(300, 180), figure_padding=5)
...
xlims!(p1ax1, high=1.5e4)
p1ax1.xticks = ([1e3, 1e4], ["10³", "10⁴"])
p2ax1.xticks = ([1e3, 1e4, 1e5, 1e6], ["10³", "10⁴", "10⁵", "10⁶"])

save(joinpath(DIR, "figure7_massmatrix_dae.pdf"), fig, pt_per_unit=1)
