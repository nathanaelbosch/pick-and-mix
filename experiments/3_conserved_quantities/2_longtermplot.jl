...
fig = Figure(resolution=(600, 200), figure_padding=5)
...
save(joinpath(DIR, "figure5_longtermplot.pdf"), fig, pt_per_unit=1)
save(joinpath(DIR, "figure5_longtermplot.png"), fig, pt_per_unit=1)
